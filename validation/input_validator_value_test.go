...
func TestRemoteHost(t *testing.T) {
	assert.Nil(t, validate("localhost", "remote_host"))
	assert.NotNil(t, validate("localhost:8443", "remote_host"))
	assert.Nil(t, validate("localhost123", "remote_host"))
	assert.Nil(t, validate("example.com", "remote_host"))
	assert.Nil(t, validate("my_example-website.com", "remote_host"))
	assert.Nil(t, validate("a.", "remote_host"))
	assert.Nil(t, validate("", "remote_host"))
	assert.Nil(t, validate(sixtyThreeHexDecimalLetters+"a", "remote_host"))
	assert.NotNil(t, validate(sixtyThreeHexDecimalLetters+"ab", "remote_host"))
}
